...
_register_embedded("training.hardcase_model_trials", r'''import json
from pathlib import Path
import numpy as np
import pandas as pd
from sklearn.model_selection import train_test_split
...
from config.config import (
    MODEL_PATH, FAMILY_CLASSIFIER_PATH, FEATURES_PKL_PATH, FEATURE_SCALER_PATH, PROCESSED_DATA_DIR, METADATA_FILE,
